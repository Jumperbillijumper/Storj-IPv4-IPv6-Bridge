...
echo "1. EXTERNE FIREWALL: Prüfe das Web-Panel deines Hosters (Oracle, Ionos, etc.)"
echo "   Dort muss der Port $STORJ_PORT für TCP UND UDP (!!!) offen sein."
echo "2. LOKALE FIREWALL: Dein PC/Server muss IPv6 Traffic auf Port $STORJ_PORT erlauben."
echo "3. FRITZBOX: IPv6-Freigabe für UDP $STORJ_PORT muss aktiv sein."
echo "4. GEDULD: QUIC kann bis zu 60 Minuten dauern, bis es im Dashboard grün wird."
echo "==============================================================="
